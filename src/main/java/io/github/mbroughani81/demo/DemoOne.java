...
class MemoryBasedDataProvider implements DataAccessProvider {
    ...
    @IOSpec(max = 10, unit = TimeUnit.MILLISECONDS, sink = true, percentile = 100, desc = "Data access")
...
class EntityService {
    ...
    @IOSpec(max = 100, unit = TimeUnit.MILLISECONDS, percentile = 100, desc = "Aggregate details")
    ...
    @IOSpec(max = 100, unit = TimeUnit.MILLISECONDS, percentile = 100, desc = "Aggregate details (optimised)")
